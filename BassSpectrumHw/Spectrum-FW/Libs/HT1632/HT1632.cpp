...
void HT1632Class::setRam(uint8_t x, uint8_t value) {
	mem[_tgtChannel][x] = value;
}

void HT1632Class::SetRamBuffer(uint8_t *array, uint8_t length) {
	for (int i=0; i<length; i++) {
		mem[_tgtChannel][i] = array[i];
	}
}
